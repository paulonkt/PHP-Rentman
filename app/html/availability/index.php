...
try {
	...
	$oDatabaseConnection->setAttribute(PDO::ATTR_DEFAULT_FETCH_MODE, PDO::FETCH_NUM);
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST') {
		...
		if (isset($_POST['equipment_id'], $_POST['quantity'], $_POST['start'], $_POST['end'], $_POST['availability'])) {
			$aResponse = $oAssessment->isAvailable($_POST['equipment_id'], $_POST['quantity'], new DateTime($_POST['start']), new DateTime($_POST['end']));
		} else if (isset($_POST['start'], $_POST['end'], ($_POST['shortages']))) {
		...
		echo '
			...
			<form method="post">
				<table>
					...
					<tr><td colspan="2"><input type="submit" name="availability"></td></tr>
				</table>
			</form>';
		...
		echo '
			...
			<form method="post">
				<table>
					...
					<tr><td colspan="2"><input type="submit" name="shortages"></td></tr>
				</table>
			</form>';
